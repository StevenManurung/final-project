...
(4, 'Ivan', 8791315189, 'Sumatera Utara', 'Berastagi', 'BTagi', 202133, 'jl.jamin ginting', 'punya pohon durian'),
(5, 'Deza', 8791315189, 'Sumatera Utara', 'Medan', 'Medan Selayang', 212233, 'jl. bunga cempaka', 'depan tukang rujak');
